...
public class TopGainer {
    ...
    public String toString() {
        ...
        sb.append(TopGainer.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("ticker");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TopGainer) == false) {
            return false;
        }
        TopGainer rhs = ((TopGainer) other);
